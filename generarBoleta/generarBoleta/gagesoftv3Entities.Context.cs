...
namespace generarBoleta
{
    ...
    public partial class db_gagesoftv3Entities : DbContext
    {
        public db_gagesoftv3Entities()
            : base("name=db_gagesoftv3Entities")
        {
        }
        ...
        public virtual DbSet<tipo_automoviles> tipo_automoviles { get; set; }
